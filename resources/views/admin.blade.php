...
<div class="sidebar" id="sidebar">
  ...
  <ul>
    ...
    <li onclick="switchTab(event,'jurusan')">Jurusan</li>
  </ul>
</div>
...
<div class="main">
  ...
  <!-- Jurusan -->
  <div class="card section" id="jurusan">
    <h3>Data Jurusan</h3>
    <button class="btn btn-add">+ Tambah Jurusan</button>
    <table class="table">
      <tr><th>Nama</th><th>Aksi</th></tr>
      <tr><td>Bu Sari</td><td>
        <button class="btn btn-edit">Edit</button>
...
.close-btn{display:none; border:none; background:transparent; color:#fff; font-size:20px; cursor:pointer;}
